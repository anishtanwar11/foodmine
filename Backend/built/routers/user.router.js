...
var user_molel_1 = require("../models/user.molel");
...
router.get("/seed", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, user_molel_1.UserModel.countDocuments()];
            case 1:
                usersCount = _a.sent();
                if (usersCount > 0) {
                ...
                return [4 /*yield*/, user_molel_1.UserModel.create(data_1.sample_users)];
            case 2:
                _a.sent();
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                return [4 /*yield*/, user_molel_1.UserModel.findOne({ email: email })];
            case 1:
                user = _c.sent();
                _b = user;
            ...
            case 3:
                if (_b) {
                    ...
                    res.status(http_status_1.HTTP_BAD_REQUEST).send("User name or passwordis not valid!");
                }
                return [2 /*return*/];
        }
    });
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, user_molel_1.UserModel.create(newUser)];
            case 3:
                dbUser = _b.sent();
